  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <h1 className={styles.title}>المواد التعليمية</h1>
        <p className={styles.subtitle}>
          استمتع بفيديوهات ومستندات تعليمية ممتعة!
        </p>
        <div className={styles.cardsContainer}>
          <div className={styles.card}>
            <div className={styles.cardContent}>
              <h3 className={styles.cardTitle}>فيديو الرياضيات</h3>
              <p className={styles.cardDescription}>
                تعلم مفاهيم الرياضيات بطريقة سهلة.
              </p>
              <a
                href="https://www.youtube.com/watch?v=example-math"
                target="_blank"
          ...
          <div className={styles.card}>
            <div className={styles.cardContent}>
              <h3 className={styles.cardTitle}>مستند العلوم</h3>
              <p className={styles.cardDescription}>
                اكتشف تجارب علمية ممتعة.
              </p>
              <a
          ...
          <div className={styles.card}>
            <div className={styles.cardContent}>
              <h3 className={styles.cardTitle}>فيديو اللغة العربية</h3>
              <p className={styles.cardDescription}>
                طور مهاراتك في القراءة والكتابة.
              </p>
              <a
                href="https://www.youtube.com/watch?v=example-arabic"
                target="_blank"
                className={styles.cardButton}
              >
                شاهد الفيديو
